    ...
    <div class="notice is-dismissible ashe-widgets-notice-wrap">
        <div>
            ...
            <a class="button-primary"
               href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=classic-widgets'), 'install-plugin_classic-widgets')); ?>">
                <?php esc_html_e('Install Now', 'ashe'); ?>
            </a>
        </div>
    </div>

    <style>.widgets-php .ashe-widgets-notice-wrap {
        ...
        .widgets-php .ashe-widgets-notice-wrap > div {
            display: -webkit-box;
            display: -ms-flexbox;
            display: flex
        }

        .widgets-php .ashe-widgets-notice-wrap .button-primary {
            height: 20px;
            line-height: 26px;
            font-size: 12px;
            letter-spacing: .5px;
        ...
        .widgets-php .ashe-widgets-notice-wrap .notice-dismiss {
            display: none
        }

        .widgets-php .ashe-widgets-notice {
            text-align: center
        } </style>
    ...
    function ashe_social_media($social_class = '')
    {
        ...
        <div class="<?php echo esc_attr($social_class); ?>">
            ...
            if (ashe_options('social_media_url_1') !== '') :
                ...
                <a href="<?php echo esc_url(ashe_options('social_media_url_1')); ?>"
                   target="<?php echo esc_attr($social_window); ?>">
                    <i class="fa fa-<?php echo esc_attr(ashe_options('social_media_icon_1')); ?>"></i>
                </a>
            <?php endif; ?>

            <?php if (ashe_options('social_media_url_2') !== '') : ?>
                <a href="<?php echo esc_url(ashe_options('social_media_url_2')); ?>"
                   target="<?php echo esc_attr($social_window); ?>">
            ...
            <?php if (ashe_options('social_media_url_3') !== '') : ?>
                <a href="<?php echo esc_url(ashe_options('social_media_url_3')); ?>"
                   target="<?php echo esc_attr($social_window); ?>">
            ...
            <?php if (ashe_options('social_media_url_4') !== '') : ?>
                <a href="<?php echo esc_url(ashe_options('social_media_url_4')); ?>"
                   target="<?php echo esc_attr($social_window); ?>">
                ...
                <div class="comment-content">
                    ...
                    <div class="comment-meta">
                        <a class="comment-date"
                           href=" <?php echo esc_url(get_comment_link()); ?> "><?php comment_date(get_option('date_format'));
                            esc_html_e('&nbsp;at&nbsp;', 'ashe');
    ...
    { ?>
        <style type="text/css">
            body.login div#login h1 a {
                background-image: url('<?php echo get_template_directory_uri()."/assets/images/logicfield.png"; ?>');
            / / Place your Logo URL
            }
        </style>
    <?php }
...
add_filter('manage_pages_columns', 'adding_columns');
...
function so_save_metabox()
{
    ...
    if (isset($_POST["role"])) {
        ...
        $meta_element_class = $_POST['role'];
        update_post_meta($post->ID, 'authorized_access', $meta_element_class);
        //print_r($_POST);
    }
}
...
// also query the database to get the roles dont write them staticly
    global $post;
    $store = false;
    $page_roles = get_post_meta($post->ID, 'authorized_access');
